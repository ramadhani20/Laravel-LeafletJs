...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="col-md-6">
            <h3 class="text-center">Update Data Delivery Zone</h3>
            <form action="{{route('zona.update', $data->id)}}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="4" name="zone_coordinates" readonly>{{$data->zone_coordinates}}
                    </textarea>
                  </div>
    ...
    var drawnItems = new L.geoJSON({!! $data->zone_coordinates !!});
